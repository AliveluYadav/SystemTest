//
//  LeafyVegetablesTableViewController.swift
//  SystemTest
//
...
class LeafyVegetablesTableViewController: UITableViewController {
    ...
    @IBAction func addAction(_ sender: Any) {
        ...
        let okAction = UIAlertAction(title: "OK", style: UIAlertActionStyle.default, handler: ({UIAlertAction in
            ...
            self.leafyVegetables.append(self.TextField.text!)
...
//    }
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return leafyVegetables.count
    }

    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath)

       cell.textLabel?.text = leafyVegetables[indexPath.row]
        return cell
    }
